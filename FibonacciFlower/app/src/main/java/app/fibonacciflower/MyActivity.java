...
public class MyActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //
        //If shit goes wrong look here at the Relative Layout
       //

        relativeLayout = (RelativeLayout) findViewById(R.id.activity_my);
